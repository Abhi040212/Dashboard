...
<style>
    ...
    @media (prefers-color-scheme: dark) {
        ...
        /* Enhanced dark mode text visibility for sidebar - CLEAN */
        ...
        /* Dark mode dropdown styling - CLEAN ALIGNMENT */
        ...
        /* Remove extended containers in dark mode */
        .stSelectbox > div {
            background: transparent !important;
            border: none !important;
            padding: 0 !important;
        ...
        /* Fix dark mode input containers */
        .stDateInput > div, .stRadio > div {
            background: transparent !important;
            border: none !important;
            padding: 0 !important;
            margin: 0 !important;
        ...
        /* Clean sidebar dropdown containers */
        ...
        /* Clean dark mode sidebar dropdowns */
        .sidebar .stSelectbox, .sidebar .stSelectbox > div,
        .sidebar .stDateInput, .sidebar .stDateInput > div,
        .sidebar .stRadio, .sidebar .stRadio > div {
        ...
        /* Clean dark mode sidebar inputs */
        .sidebar .stDateInput input,
        .sidebar .stTextInput input,
        .sidebar .stNumberInput input {
            background: rgba(40, 44, 52, 0.95) !important;
    ...
    /* Universal enhanced text visibility - CLEAN & SIMPLE */
    .stSelectbox label, .stDateInput label, .stRadio label {
    ...
    /* Clean dropdown styling - SIMPLE & READABLE */
    .stSelectbox div[data-baseweb="select"] {
    ...
    /* Remove extended containers in light mode */
    .stSelectbox > div {
        background: transparent !important;
        border: none !important;
        padding: 0 !important;
    ...
    /* Remove extended containers for inputs and radio */
    .stDateInput > div, .stRadio > div {
        background: transparent !important;
        border: none !important;
        padding: 0 !important;
    ...
    /* Clean spacing between filter groups - BOTH MODES */
    ...
    .sidebar .stMarkdown p, .sidebar .stMarkdown div {
        ...
        border: none !important;
        text-shadow: none !important;
    }: 2px solid rgba(59, 130, 246, 0.4) !important;
        display: block !important;
        width: 100% !important;
        box-sizing: border-box !important;
    ...
    /* Simple radio button styling - BOTH MODES */
    .stRadio > div > label > div[data-testid="stMarkdownContainer"] > p {
        color: var(--text-primary) !important;
        font-weight: 600 !important;
        font-size: 1rem !important;
    ...
    /* Simple sidebar header - BOTH MODES */
    .sidebar .stMarkdown h3 {
        color: var(--text-primary) !important;
        font-weight: 700 !important;
        font-size: 1.2rem !important;
    ...
    * {
    ...
    /* Clean light mode sidebar dropdowns */
    .sidebar .stSelectbox div[data-baseweb="select"] {
        background: rgba(255, 255, 255, 0.95) !important;
    ...
    .sidebar .stSelectbox div[data-baseweb="select"]:focus-within {
    ...
    /* Clean sidebar input styling - light mode */
    .sidebar .stDateInput input,
    .sidebar .stTextInput input,
    .sidebar .stNumberInput input {
        background: rgba(255, 255, 255, 0.95) !important;
    ...
    .sidebar .stDateInput input:hover,
    .sidebar .stTextInput input:hover,
    .sidebar .stNumberInput input:hover {
        border-color: rgba(59, 130, 246, 0.5) !important;
    }
    
    .sidebar .stDateInput input:focus,
