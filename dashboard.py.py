...
with st.sidebar:
    ...
    if df is not None and not df.empty:
        ...
        if 'Source' in df.columns:
            ...
            selected_source = st.selectbox("Select Source", options=["All"] + sources)
        else:
            selected_source = "All"
        ...
        if 'Sales Team' in df.columns:
            ...
            selected_sales_team = st.selectbox("Select Sales Team", options=["All"] + sales_teams)
        else:
        ...
        if 'AE' in df.columns:
            ...
            selected_ae = st.selectbox("Select AE", options=["All"] + aes)
        else:
            selected_ae = "All"
